...
!!! note Checklist
    ...
    - [ ] Create an empty repository (namely, `https://github.com/okatsn/MyUtilBox.jl.git`) on github, and push the local to origin. See [connecting to remote](#tips-for-connecting-to-remote).
    ...
    - [ ] You might like to register `v0.0.0` in order to `pkg> dev MyUtilBox` in your environment.
